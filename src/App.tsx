...
export default function App() {
  ...
  return (
    <div className="page">
      ...
      <section className="examples" ref={examplesRef}>
      ...
      <section className="studio" ref={studioRef}>
          ...
          <div className="legend">
            <h3>
              ...
              <span className="legend-meta">
                {pattern.palette.length} · {pattern.width}×{pattern.height}
              </span>
            </h3>
            <ul>
        ...
        <div className="actions">
          <button type="button" className="btn ghost" onClick={reset} disabled={!pattern && !source}>
            {t.reset}
          </button>
        </div>
      </section>
